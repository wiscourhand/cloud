...
import (
	...
	"github.com/wiscourhand/idl/kitex_gen/base"
	"strings"
)
...
type ExampleServiceExampleMethodArgs struct {
	Req *ExampleReq `thrift:"req,1" frugal:"1,default,ExampleReq" json:"req"`
}
...
type ExampleServiceExampleMethodResult struct {
	Success *ExampleResp `thrift:"success,0,optional" frugal:"0,optional,ExampleResp" json:"success,omitempty"`
}
